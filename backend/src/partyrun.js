...
const BUFF_META = {
  ...
  // CRB batch 10 (poker v3.37.160)
  magicweapon:   { icon: '🗡️', img: BI('bullsstrength'), label: 'Magic Weapon', desc: '+1 enhancement to hit & damage (this room)' },
  greatermagicfang: { icon: '🐾', img: BI('bullsstrength'), label: 'Greater Magic Fang', desc: '+1 per 4 caster levels to hit & damage with natural weapons (this dungeon)' },
  aid:           { icon: '🛡️', img: BI('protevil'), label: 'Aid', desc: '+1 to hit, +1 on saves, temp HP (this room)' },
  ragespell:     { icon: '😤', img: BI('rage'), label: 'Rage (spell)', desc: '+1 to hit & damage, +1 Will, temp HP, −2 AC (this room)' },
  massenlarge:   { icon: '🦣', img: BI('bullsstrength'), label: 'Mass Enlarge Person', desc: 'grown a size category — +2 damage (this room)' },
  eaglessplendor: { icon: '🦅', img: BI('fly'), label: 'Eagle\'s Splendor', desc: '+2 spell DCs & spell attacks for a Charisma caster (this room)' },
  foxscunning:   { icon: '🦊', img: BI('fly'), label: 'Fox\'s Cunning', desc: '+2 spell DCs & spell attacks for an Intelligence caster (this room)' },
  owlswisdom:    { icon: '🦉', img: BI('fly'), label: 'Owl\'s Wisdom', desc: '+2 spell DCs & spell attacks for a Wisdom caster (this room)' },
  masseagles:    { icon: '🦅', img: BI('fly'), label: 'Mass Eagle\'s Splendor', desc: '+2 spell DCs & spell attacks for Charisma casters (this room)' },
  massfoxes:     { icon: '🦊', img: BI('fly'), label: 'Mass Fox\'s Cunning', desc: '+2 spell DCs & spell attacks for Intelligence casters (this room)' },
  massowls:      { icon: '🦉', img: BI('fly'), label: 'Mass Owl\'s Wisdom', desc: '+2 spell DCs & spell attacks for Wisdom casters (this room)' },
  massbears:     { icon: '🐻', img: BI('bullsstrength'), label: 'Mass Bear\'s Endurance', desc: 'temporary HP (+2 per level) — whole party (this room)' },
  massbulls:     { icon: '💪', img: BI('bullsstrength'), label: 'Mass Bull\'s Strength', desc: '+2 to hit & +2 melee damage — whole party (this room)' },
  masscats:      { icon: '🐈', img: BI('bullsstrength'), label: 'Mass Cat\'s Grace', desc: '+2 AC & +1 ranged to-hit — whole party (this room)' },
  // CRB batch 11 (poker v3.37.161): the wards
  blur:          { icon: '🌫️', img: BI('fly'), label: 'Blur', desc: '20% of attacks on you miss (this room)' },
  entropicshield: { icon: '🌀', img: BI('protevil'), label: 'Entropic Shield', desc: 'enemy ranged attacks miss you 20% (this room)' },
  protarrows:    { icon: '🏹', img: BI('protevil'), label: 'Protection from Arrows', desc: 'DR 10 vs ranged weapons from a pool (this room)' },
  sanctuary:     { icon: '🕊️', img: BI('protevil'), label: 'Sanctuary', desc: 'untargetable until you attack' },
  keenedge:      { icon: '🔪', img: BI('bullsstrength'), label: 'Keen Edge', desc: 'doubled critical threat range (this room)' },
  blessweapon:   { icon: '✝️', img: BI('bullsstrength'), label: 'Bless Weapon', desc: 'crits vs evil confirm automatically (this room)' },
  resistfire: { icon: '🔥', img: BI('protevil'), label: 'Resist Energy (Fire)', desc: 'the first 10/20/30 fire of each hit ignored (this room)' },
  resistcold: { icon: '❄️', img: BI('protevil'), label: 'Resist Energy (Cold)', desc: 'the first 10/20/30 cold of each hit ignored (this room)' },
  resistacid: { icon: '🧪', img: BI('protevil'), label: 'Resist Energy (Acid)', desc: 'the first 10/20/30 acid of each hit ignored (this room)' },
  resistelectricity: { icon: '⚡', img: BI('protevil'), label: 'Resist Energy (Electricity)', desc: 'the first 10/20/30 electricity of each hit ignored (this room)' },
  resistsonic: { icon: '📢', img: BI('protevil'), label: 'Resist Energy (Sonic)', desc: 'the first 10/20/30 sonic of each hit ignored (this room)' },
  protectcold: { icon: '❄️', img: BI('protectfire'), label: 'Protection from Cold', desc: 'absorbs cold damage from a 12/CL pool (this room)' },
  protectacid: { icon: '🧪', img: BI('protectfire'), label: 'Protection from Acid', desc: 'absorbs acid damage from a 12/CL pool (this room)' },
  protectelectricity: { icon: '⚡', img: BI('protectfire'), label: 'Protection from Electricity', desc: 'absorbs electricity damage from a 12/CL pool (this room)' },
  protectsonic: { icon: '📢', img: BI('protectfire'), label: 'Protection from Sonic', desc: 'absorbs sonic damage from a 12/CL pool (this room)' },
  shieldother:   { icon: '🛡️', img: BI('protevil'), label: 'Shield Other', desc: 'half of your wounds land on the caster (this room)' },
  spellturning:  { icon: '🔁', img: BI('protevil'), label: 'Spell Turning', desc: 'the next 3 enemy spells aimed at you are turned aside' },
  cloakofchaos:  { icon: '🌀', img: BI('protevil'), label: 'Cloak of Chaos', desc: '+4 AC, +4 saves, SR 12+CL (this room)' },
  holyaura:      { icon: '✨', img: BI('protevil'), label: 'Holy Aura', desc: '+4 AC, +4 saves, SR 12+CL (this room)' },
  shieldoflaw:   { icon: '⚖️', img: BI('protevil'), label: 'Shield of Law', desc: '+4 AC, +4 saves, SR 12+CL (this room)' },
  unholyaura:    { icon: '🕯️', img: BI('protevil'), label: 'Unholy Aura', desc: '+4 AC, +4 saves, SR 12+CL (this room)' },
  transformation: { icon: '⚔️', img: BI('bullsstrength'), label: 'Transformation', desc: '+2 hit & damage, +4 AC, temp HP — no spells (this room)' },
  antilifeshell: { icon: '⭕', img: BI('protevil'), label: 'Antilife Shell', desc: 'living melee foes cannot close on you (this room)' },
