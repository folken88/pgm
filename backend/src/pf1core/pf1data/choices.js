...
const CAVALIER_ORDERS = [
  ...
  { key: 'cockatrice', name: 'Order of the Cockatrice', icon: '🐔', built: true,
    desc: 'Selfish glory. Bonus damage against your challenged foe while you fight it ALONE; a Dazzling Display that shakens the whole room (L2); steal a free strike whenever an ally crits (L8); and once a room, refuse to fall (L15).',
  ...
  { key: 'shield', name: 'Order of the Shield', icon: '🛡️', built: true,
    desc: 'The protector of the weak. +to-hit against a challenged foe that dared strike an ally; passive damage reduction (L2); a free interrupt-strike whenever a foe attacks an ally (L8); and throw yourself in the way to shield a comrade (L15).',
